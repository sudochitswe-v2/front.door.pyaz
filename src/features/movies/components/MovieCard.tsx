...
export const MovieCard: React.FC<MovieCardProps> = ({ movie }) => {
    ...
    return (
        <Link to={`/play/${movie.id}`} className="movie-card">
            <div className="bg-gray-800 rounded-lg shadow-md border border-gray-700 overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col h-full group">
